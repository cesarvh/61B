...
public class YearlyRecordDemo {
    public static void main(String[] args) {
        ...
        System.out.println("surrogate rank:" + yr.rank("surrogate")); // should print 1
        System.out.println("quayside rank: " + yr.rank("quayside")); // should print 3
        System.out.println("merchantman rank: " + yr.rank("merchantman"));
        ...
        */
        ...
        System.out.println(yr2.size());
        System.out.println(yr2.rank("berry"));
        System.out.println(yr2.rank("temporariness"));
        System.out.println(yr2.rank("puppetry"));
        System.out.println(yr2.rank("auscultating")); 
        System.out.println(yr.rank("Hello"));
