...
public class Plotter {
    ...
    private static final int EIGHTHUNNY = 800;
    private static final int SIXHUNNY = 600;
    ...
    public static void plotCategoryWeights(NGramMap ngm, WordNet wn, String[] categoryLabels,
                                            int startYear, int endYear) {
        Chart chart = new 
            ChartBuilder().width(EIGHTHUNNY).height(
            SIXHUNNY).xAxisTitle("years").yAxisTitle("data").build();
    ...
    public static void plotAllWords(NGramMap ngm, String[] words, int startYear, int endYear) {
        Chart chart = 
            new ChartBuilder().width(EIGHTHUNNY).height(
                SIXHUNNY).xAxisTitle("years").yAxisTitle("data").build();
    ...
    public static void plotZipfsLaw(NGramMap ngm, int year) {
        ...
        Chart chart = 
            new ChartBuilder().width(EIGHTHUNNY).height(
                SIXHUNNY).xAxisTitle("rank").yAxisTitle("count").build();
