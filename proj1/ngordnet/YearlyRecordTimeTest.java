...
public class YearlyRecordTimeTest {
    ...
    private static final int LAS = 10000;

    /** Stright from: http://www.baeldung.com/java-random-string. Returns
      * a random string. */
    public static String randomString() {
        int leftLimit = NINETYSEVEN; // letter 'a'
    ...
    /* Tests to see if you can insert BIG strings in less than a second. 
    ...
    /* Tests to see if you can insert LAST strings in less than a second. */
    @Test(timeout = LAST)
    ...
    public static void main(String... args) {
        ...
        System.out.println(" * TestPut100000: Can your code insert BIG items into a");
        System.out.println("   yearly record in less than 1 second? Pass on submit/proj1");
        System.out.println("   for 0.1 bonus points.\n");        

        System.out.println(" * TestPut1000: Can your code insert LAST items into a");
